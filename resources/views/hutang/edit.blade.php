                    ...
                    <div class="row">
                        <div class="col">
                            <div class="form-group">
                                ...
                                <input name="id_hutang" class="form-control" value="{{ $hutang->id_hutang }}" readonly>
                            </div>
                            <br>
                            <div class="form-group">
                                <label>ID Supplier</label>
                                <input name="id_supplier" class="form-control" value="{{ $hutang->id_supplier }}" readonly>
                            </div>
                            <br>
                            <div class="form-group">
                                <label>Nominal Hutang</label>
                                <input type="number" name="nominal_hutang" class="form-control" value="{{ $hutang->nominal_hutang }}" readonly>
                            ...
                            <div class="form-group">
                                ...
                                <input type="number" name="nominal_terbayar" class="form-control" value="{{ $hutang->nominal_terbayar }}">
                                <div class="text-danger">
                            ...
                            <div class="form-group">
                                ...
                                <input name="jenis_hutang" class="form-control" value="{{ $hutang->jenis_hutang }}" readonly>
                                <div class="text-danger">
                                    @error('jenis_hutang')
                                        {{ $message }}
                                    @enderror
                            ...
                            <div class="form-group">
                                ...
                                <input type="date" name="tgl_hutang" class="form-control" value="{{ $hutang->tgl_hutang}}" readonly>
                                <div class="text-danger">
                                    @error('tgl_hutang')
                                        {{ $message }}
                                    @enderror
                            ...
                            <div class="form-group">
                                ...
                                <input type="date" name="jatuh_tempo" class="form-control" value="{{ $hutang->jatuh_tempo}}" readonly>
                                <div class="text-danger">
                                    @error('jatuh_tempo')
                                        {{ $message }}
                                    @enderror
                            ...
                            <div class="form-group">
                                ...
                                <select class="form-control" name="ket_lunas" id="ket_lunas">
                                    ...
                                    @foreach($lunashutangs as $lunashutang)
                                        <option data-row="{{$lunashutang}}" @if (isset($hutang)) @if ($hutang->ket_lunas == $lunashutang['jenis_lunas']) selected @endif @endif>{{$lunashutang['jenis_lunas']}}</option>
                                    @endforeach
                                </select>
                                <div class="text-danger">
                                    @error('ket_lunas')
                            ...
                            <div class="">
                                ...
                                <a class="btn btn-primary" href="{{ route('hutang.index') }}"> Kembali</a>
                            </div>
                        </div>
                    </div>
                </div>
